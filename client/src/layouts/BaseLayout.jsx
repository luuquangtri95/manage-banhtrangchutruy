				...
				<div
					...
					<div className="mt-2 flex flex-col">
							...
							{isCollapse && (
								<div className="flex items-center flex-col">
									<NavLink
										...
										className={({ isActive }) =>
											`p-3 rounded-md ${isActive ? "bg-main" : "bg-none"}`
										}>
							...
							{renderContent && !isCollapse && (
								<ul>
									<NavLink
										to="/dashboard/order-create"
										className={({ isActive }) =>
											`p-3 flex items-center gap-2 mb-1 hover:bg-main transition-all rounded-md ${
												isActive ? "bg-main" : ""
											}`
										}>
										<Icon type="icon-create" />
						...
						<div className="flex-1">
							<button
								className="p-3 flex items-center gap-2 mb-1 hover:bg-main transition-all rounded-md"
								onClick={onLogout}>
